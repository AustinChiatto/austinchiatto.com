import { ContactIcons } from '@/data/content';

export type Icons = {
  name: 'palette' | 'plus' | ContactIcons;
  fill?: string;
  className?: string;
};
...
const Icon = ({ name, fill = 'secondary-foreground', className }: Icons) => {
  return <span className={`${fill} ${className}`}>{icons[name]}</span>;
};
